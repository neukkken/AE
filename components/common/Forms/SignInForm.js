...
export default function SignInForm() {
  ...
  return (
    <form className="FormNav" onSubmit={handleSumbit}> 
      <h1>Inicia Sesion</h1>
      <input value={inputEmail} onChange={handleChangeEmail} type="email" placeholder="Correo Electronico" />
      <input value={inputPassword} onChange={handleChangePassword} type="password" placeholder="Contraseña" />
      <label>
        <span>
