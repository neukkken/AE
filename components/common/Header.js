    ...
    <header id="MainHeader" className="MainHeader">
      ...
      <nav>
        ...
        <li>
          ...
          <Link href="/empresarios/solicitudes">Solicitudes</Link>
        </li>
        <li>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <Link href="/empresarios/perfil">Perfil</Link>
        </li>
        <li>
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <Link href="/empresarios/convocatorias">Convocatorias</Link>
        </li>
        <li>
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="searchBar">
        <input type="text" placeholder="BUSCAR EN AGROEMPRENDE" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
          y="0px"
